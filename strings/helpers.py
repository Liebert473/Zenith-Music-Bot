...
_HELP_5p2_EN = """📄 **Sudo Commands — Page 2 / 2**
...
🌐**<u>BROADCAST:</u>**
Sends text **or media** (photo, GIF, video, doc, audio, sticker) to all served chats.
...
# ── PAGE 2: Burmese ──────────────────────────────────────────────────────
_HELP_5p2_MY = """📄 **[SUDO COMMANDS :: PAGE 2 / 2]**
